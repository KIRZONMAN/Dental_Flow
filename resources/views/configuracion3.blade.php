...
$nombre = isset($_SESSION["nombre"]) ? $_SESSION["nombre"] : "Admin. (Nombre)";
$telefono = isset($_SESSION["telefono"]) ? $_SESSION["telefono"] : "+12 34567890";
$email = isset($_SESSION["email"]) ? $_SESSION["email"] : "administrador@dominio.com";
$recordatorios = isset($_SESSION["recordatorios"]) ? $_SESSION["recordatorios"] : "";
$especialidad = "Administrador"; // Fijo y no editable
?>
