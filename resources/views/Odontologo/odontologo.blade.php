...
<body class="bg-light">
  <div class="d-flex" id="wrapper">
    ...
    <!-- Sidebar fijo en desktop, oculto en móvil -->
    ...
    <div id="page-content-wrapper" class="w-100">
      ...
      <header
        class="odont-header shadow-sm px-4 py-3 d-flex align-items-center justify-content-between bg-light">
        <!-- Toggle sidebar en móvil -->
        <button class="btn btn-outline-primary me-4" id="sidebarToggle">
        ...
        <div class="d-flex gap-2">
          ...
          <a href="/login" class="btn btn-outline-danger"><i class="fas fa-sign-out-alt"></i> Cerrar Sesión</a>
        </div>
      </header>

      <main class="container-fluid py-4">
        <div class="row g-4">
          <!-- Estadística Citas Hoy -->
          ...
          <div class="col-12">
            <section class="card shadow-sm p-4">
              <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center mb-3">
                ...
                <a href="{{ route('odontologo.agenda') }}" class="btn btn-outline-primary mt-2 mt-md-0">
          ...
          <div class="col-12 col-lg-6">
            <section class="card shadow-sm p-4">
              ...
              <a href="{{ route('odontologo.ordenes') }}" class="btn btn-outline-info mt-2">
                <i class="fas fa-folder-open"></i> Ir a Órdenes
              </a>
            </section>
          </div>
